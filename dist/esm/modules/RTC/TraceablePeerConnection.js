...
TraceablePeerConnection.prototype.getRemoteSourceInfoByParticipant = function (id) {
    ...
    for (const [sourceName, sourceInfo] of this._remoteSsrcMap) {
        if ((_a = sourceInfo.ssrcList) === null || _a === void 0 ? void 0 : _a.some(ssrc => primarySsrcs.includes(Number(ssrc)))) {
...
TraceablePeerConnection.prototype.getTrackBySSRC = function (ssrc) {
    ...
    for (const localTrack of this.localTracks.values()) {
        const { ssrcs } = (_a = this.localSSRCs.get(localTrack.rtcId)) !== null && _a !== void 0 ? _a : { ssrcs: [] };
...
TraceablePeerConnection.prototype._remoteTrackAdded = function (stream, track, transceiver = null) {
    ...
    const trackDetails = {
        mediaType,
        muted: (_a = peerMediaInfo === null || peerMediaInfo === void 0 ? void 0 : peerMediaInfo.muted) !== null && _a !== void 0 ? _a : true,
        stream,
        track,
        ssrc: trackSsrc,
        videoType: peerMediaInfo === null || peerMediaInfo === void 0 ? void 0 : peerMediaInfo.videoType
    };
...
TraceablePeerConnection.prototype._processAndExtractSourceInfo = function (localSDP) {
    ...
    for (const localTrack of this.localTracks.values()) {
        ...
        if (ssrcs === null || ssrcs === void 0 ? void 0 : ssrcs.length) {
            ...
            if (ssrcGroups === null || ssrcGroups === void 0 ? void 0 : ssrcGroups.length) {
...
TraceablePeerConnection.prototype.addTrack = function (track, isInitiator = false) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (browser.isFirefox() && webrtcStream) {
            yield this._setEncodings(track);
        }
    });
};
/**
...
TraceablePeerConnection.prototype.getConfiguredVideoCodecs = function (description) {
    return this.tpcUtils.getConfiguredVideoCodecs(description === null || description === void 0 ? void 0 : description.sdp);
};
/**
...
TraceablePeerConnection.prototype.processLocalSdpForTransceiverInfo = function (localTracks) {
    var _a;
    const localSdp = (_a = this.localDescription) === null || _a === void 0 ? void 0 : _a.sdp;
    if (!localSdp) {
        return;
    }
...
TraceablePeerConnection.prototype.replaceTrack = function (oldTrack, newTrack, isMuteOperation = false) {
    ...
    return transceiver.sender.replaceTrack(track)
        ...
        if (newTrack) {
            ...
            this.localTrackTransceiverMids.set(newTrack.rtcId, (_a = transceiver === null || transceiver === void 0 ? void 0 : transceiver.mid) === null || _a === void 0 ? void 0 : _a.toString());
...
TraceablePeerConnection.prototype._configureSenderEncodings = function (localTrack) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const transceiver = (localTrack === null || localTrack === void 0 ? void 0 : localTrack.track) && localTrack.getOriginalStream()
            ? this.peerconnection.getTransceivers().find(t => { var _a, _b; return ((_b = (_a = t.sender) === null || _a === void 0 ? void 0 : _a.track) === null || _b === void 0 ? void 0 : _b.id) === localTrack.getTrackId(); })
            : this.peerconnection.getTransceivers().find(t => { var _a, _b; return ((_b = (_a = t.receiver) === null || _a === void 0 ? void 0 : _a.track) === null || _b === void 0 ? void 0 : _b.kind) === mediaType; });
...
TraceablePeerConnection.prototype.configureVideoSenderEncodings = function (localVideoTrack, codec) {
    var _a, _b;
    const preferredCodec = codec !== null && codec !== void 0 ? codec : this.codecSettings.codecList[0];
    if (localVideoTrack) {
        const height = (_a = this._senderMaxHeights.get(localVideoTrack.getSourceName())) !== null && _a !== void 0 ? _a : VIDEO_QUALITY_LEVELS[0].height;
        return this.setSenderVideoConstraints(height, localVideoTrack, preferredCodec);
    }
    const promises = [];
    for (const track of this.getLocalVideoTracks()) {
        const maxHeight = (_b = this._senderMaxHeights.get(track.getSourceName())) !== null && _b !== void 0 ? _b : VIDEO_QUALITY_LEVELS[0].height;
...
TraceablePeerConnection.prototype.setSenderVideoConstraints = function (frameHeight, localVideoTrack, preferredCodec) {
    ...
    const codec = preferredCodec !== null && preferredCodec !== void 0 ? preferredCodec : this.codecSettings.codecList[0];
...
TraceablePeerConnection.prototype._updateVideoSenderEncodings = function (frameHeight, localVideoTrack, preferredCodec) {
    ...
    const codecForCamera = preferredCodec !== null && preferredCodec !== void 0 ? preferredCodec : this.tpcUtils.getConfiguredVideoCodec(localVideoTrack);
    ...
    for (const idx in parameters.encodings) {
        if (parameters.encodings.hasOwnProperty(idx)) {
            const { active = undefined, codec: currentCodec = undefined, maxBitrate = undefined, scalabilityMode = undefined, scaleResolutionDownBy = undefined } = parameters.encodings[idx];
            ...
            if (this.usesCodecSelectionAPI() && (currentCodec === null || currentCodec === void 0 ? void 0 : currentCodec.mimeType) !== expectedPattern) {
                const matchingCodec = parameters.codecs.find(pt => pt.mimeType === expectedPattern);
                parameters.encodings[idx].codec = matchingCodec;
                needsUpdate = true;
                Statistics.sendAnalytics(VIDEO_CODEC_CHANGED, {
                    value: codec,
                    videoType
                });
            }
