...
export class TPCUtils {
    ...
    constructor(peerconnection, options = {}) {
        ...
        if (videoQualitySettings) {
            for (const codec of VIDEO_CODECS) {
                ...
                const bitrateSettings = (_a = codecConfig === null || codecConfig === void 0 ? void 0 : codecConfig.maxBitratesVideo) !== null && _a !== void 0 ? _a : (videoQualitySettings.maxbitratesvideo
    ...
    _calculateActiveEncodingParams(localVideoTrack, codec, newHeight) {
        ...
        const desktopShareBitrate = ((_a = this.options.videoQuality) === null || _a === void 0 ? void 0 : _a.desktopbitrate) || codecBitrates.ssHigh;
    ...
    getConfiguredVideoCodec(localTrack) {
        var _a;
        const localVideoTrack = localTrack !== null && localTrack !== void 0 ? localTrack : this.pc.getLocalVideoTracks()[0];
        ...
        const sdp = (_a = this.pc.remoteDescription) === null || _a === void 0 ? void 0 : _a.sdp;
        if (!sdp) {
    ...
    getConfiguredVideoCodecs(sdp) {
        var _a;
        const currentSdp = sdp !== null && sdp !== void 0 ? sdp : (_a = this.pc.localDescription) === null || _a === void 0 ? void 0 : _a.sdp;
        if (!currentSdp) {
            return [];
        }
