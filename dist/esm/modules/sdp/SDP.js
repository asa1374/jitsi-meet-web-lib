...
export default class SDP {
    ...
    fromJingle(jingle) {
        ...
        newSession.media.forEach(mLine => {
            ...
            if (!((_a = mLine.ssrcs) === null || _a === void 0 ? void 0 : _a.length)) {
                const newMline = cloneDeep(mLine);
                newMline.mid = newMedia.length.toString();
                newMedia.push(newMline);
                return;
            ...
            mLine.ssrcs.forEach((ssrc, idx) => {
                ...
                if (newMedia.some(mline => { var _a; return (_a = mline.ssrcs) === null || _a === void 0 ? void 0 : _a.some(source => source.id === ssrc.id); })) {
                    return;
                }
                const newMline = cloneDeep(mLine);
                newMline.ssrcs = [];
                ...
                const group = (_a = mLine.ssrcGroups) === null || _a === void 0 ? void 0 : _a.find(g => g.ssrcs.includes(ssrcId));
                if (group) {
