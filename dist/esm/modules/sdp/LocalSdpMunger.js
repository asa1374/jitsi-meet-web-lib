...
export default class LocalSdpMunger {
    ...
    _transformMediaIdentifiers(mediaSection, ssrcMap) {
        ...
        const sources = [...new Set((_a = mediaSection.mLine.ssrcs) === null || _a === void 0 ? void 0 : _a.map(s => s.id))];
        let trackId = (_b = mediaSection.mLine.msid) === null || _b === void 0 ? void 0 : _b.split(' ')[1];
        let sourceName;
        if (ssrcMap.size) {
            ...
            for (const source of sources) {
                if ((mediaDirection === MediaDirection.SENDONLY || mediaDirection === MediaDirection.SENDRECV)
                    ...
                    const videoType = (_c = this.tpc.getLocalVideoTracks()
                        .find(track => track.getSourceName() === sourceName)) === null || _c === void 0 ? void 0 : _c.getVideoType();
