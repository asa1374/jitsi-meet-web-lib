...
import { ICE_DURATION, ICE_STATE_CHANGED, VIDEO_CODEC_CHANGED } from '../../service/statistics/AnalyticsEvents';
...
function _addSourceElement(description, s, ssrc_, msid) {
    ...
    description.c('source', {
        ...
        ssrc: ssrc_,
        name: s.source,
        videoType: (_a = s.videoType) === null || _a === void 0 ? void 0 : _a.toLowerCase()
    })
        .c('parameter', {
        name: 'msid',
        value: msid
...
export default class JingleSessionPC extends JingleSession {
    ...
    _addOrRemoveRemoteStream(isAdd, elem) {
        ...
        const workFunction = finishedCallback => {
            var _a;
            if (!((_a = this.peerconnection.remoteDescription) === null || _a === void 0 ? void 0 : _a.sdp)) {
            ...
            for (const description of descriptionsWithSources) {
                ...
                for (const source of sources) {
                    ...
                    if (sourceDescription.has(sourceName)) {
                        (_a = sourceDescription.get(sourceName).ssrcList) === null || _a === void 0 ? void 0 : _a.push(ssrc);
                    }
                    else {
    ...
    doInitialize(options) {
        var _a, _b, _c;
        this.failICE = Boolean((_a = options.testing) === null || _a === void 0 ? void 0 : _a.failICE);
        this.lasticecandidate = false;
        ...
        pcOptions.usesCodecSelectionAPI = this.usesCodecSelectionAPI
            = browser.supportsCodecSelectionAPI() && ((_b = options.testing) === null || _b === void 0 ? void 0 : _b.enableCodecSelectionAPI) && !this.isP2P;
        ...
        if (!this.isP2P) {
            ...
            pcOptions.capScreenshareBitrate = !(((_c = options.desktopSharingFrameRate) === null || _c === void 0 ? void 0 : _c.max) > SS_DEFAULT_FRAME_RATE);
        }
