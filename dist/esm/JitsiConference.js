...
import { ACTION_JINGLE_RESTART, ACTION_JINGLE_SI_RECEIVED, ACTION_JINGLE_SI_TIMEOUT, ACTION_JINGLE_TERMINATE, ACTION_JVB_ICE_FAILED, ACTION_P2P_DECLINED, ACTION_P2P_ESTABLISHED, ACTION_P2P_FAILED, ACTION_P2P_SWITCH_TO_JVB, ICE_ESTABLISHMENT_DURATION_DIFF, createConferenceEvent, createJingleEvent, createJvbIceFailedEvent, createP2PEvent } from './service/statistics/AnalyticsEvents';
...
JitsiConference.prototype._init = function (options = {}) {
    ...
    const qualityOptions = {
        enableAdaptiveMode: (_b = config.videoQuality) === null || _b === void 0 ? void 0 : _b.enableAdaptiveMode,
        lastNRampupTime: (_d = (_c = config.testing) === null || _c === void 0 ? void 0 : _c.lastNRampupTime) !== null && _d !== void 0 ? _d : 60000,
        jvb: {
            preferenceOrder: browser.isMobileDevice()
                ? (_e = config.videoQuality) === null || _e === void 0 ? void 0 : _e.mobileCodecPreferenceOrder
                : (_f = config.videoQuality) === null || _f === void 0 ? void 0 : _f.codecPreferenceOrder,
            disabledCodec: _getCodecMimeType((_g = config.videoQuality) === null || _g === void 0 ? void 0 : _g.disabledCodec),
            preferredCodec: _getCodecMimeType((_h = config.videoQuality) === null || _h === void 0 ? void 0 : _h.preferredCodec),
            screenshareCodec: browser.isMobileDevice()
                ? _getCodecMimeType((_j = config.videoQuality) === null || _j === void 0 ? void 0 : _j.mobileScreenshareCodec)
                : _getCodecMimeType((_k = config.videoQuality) === null || _k === void 0 ? void 0 : _k.screenshareCodec)
        },
        p2p: {
            preferenceOrder: browser.isMobileDevice()
                ? (_l = config.p2p) === null || _l === void 0 ? void 0 : _l.mobileCodecPreferenceOrder
                : (_m = config.p2p) === null || _m === void 0 ? void 0 : _m.codecPreferenceOrder,
            disabledCodec: _getCodecMimeType((_o = config.p2p) === null || _o === void 0 ? void 0 : _o.disabledCodec),
            preferredCodec: _getCodecMimeType((_p = config.p2p) === null || _p === void 0 ? void 0 : _p.preferredCodec),
            screenshareCodec: browser.isMobileDevice()
                ? _getCodecMimeType((_q = config.p2p) === null || _q === void 0 ? void 0 : _q.mobileScreenshareCodec)
                : _getCodecMimeType((_r = config.p2p) === null || _r === void 0 ? void 0 : _r.screenshareCodec)
        }
    };
    ...
    const transcriptionLanguage = (_s = config === null || config === void 0 ? void 0 : config.transcriptionLanguage) !== null && _s !== void 0 ? _s : DEFAULT_TRANSCRIPTION_LANGUAGE;
...
JitsiConference.prototype.leave = function (reason) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (reason === 'switch_room' && ((_a = this.getBreakoutRooms()) === null || _a === void 0 ? void 0 : _a.isBreakoutRoom())) {
...
JitsiConference.prototype.addTrack = function (track) {
    ...
    if (localTracks.length > 0) {
        ...
        if (((_a = this.options.config.testing) === null || _a === void 0 ? void 0 : _a.allowMultipleTracks)
            || (mediaType === MediaType.VIDEO && !localTracks.find(t => t.getVideoType() === track.getVideoType()))) {
            const sourceName = getSourceNameForJitsiTrack(this.myUserId(), mediaType, (_b = this.getLocalTracks(mediaType)) === null || _b === void 0 ? void 0 : _b.length);
...
JitsiConference.prototype._setBridgeChannel = function (offerIq, pc) {
    ...
    const preferSctp = (_g = (_f = (_e = (_d = this.connection) === null || _d === void 0 ? void 0 : _d.options) === null || _e === void 0 ? void 0 : _e.bridgeChannel) === null || _f === void 0 ? void 0 : _f.preferSctp) !== null && _g !== void 0 ? _g : true;
...
JitsiConference.prototype._onIceConnectionFailed = function (session) {
    ...
    if (session.isP2P) {
        ...
        Statistics.sendAnalyticsAndLog(createJvbIceFailedEvent(ACTION_JVB_ICE_FAILED, {
            participantId: this.myUserId(),
            userRegion: (_a = this.options.config.deploymentInfo) === null || _a === void 0 ? void 0 : _a.userRegion
        }));
...
JitsiConference.prototype._maybeStartOrStopP2P = function (userLeftEvent) {
    ...
    if (!this.p2pJingleSession && shouldBeInP2P) {
        ...
        if ((_a = this.options.config.testing) === null || _a === void 0 ? void 0 : _a.forceInitiator) {
            logger.debug(`Forcing P2P initiator, will start P2P with: ${jid}`);
            this._startP2PSession(jid);
        }
        else if ((_b = this.options.config.testing) === null || _b === void 0 ? void 0 : _b.forceResponder) {
