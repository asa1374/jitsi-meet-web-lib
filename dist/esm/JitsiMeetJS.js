...
import runPreCallTest from './modules/statistics/PreCallTest';
    ...
    */
    ...
    createLocalTracks(options = {}) {
        ...
        return RTC.obtainAudioAndVideoPermissions(options)
            ...
            Statistics.sendAnalytics(createGetUserMediaEvent('success', getAnalyticsAttributesFromOptions(options)));
